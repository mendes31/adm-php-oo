...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4 border-light shadow">
        ...
        <div class="card-header hstack gap-2">
            ...
            <span class="ms-auto">
                <a href="<?php echo $_ENV['URL_ADM']; ?>create-package" class="btn btn-success btn-sm"><i class="fa-regular fa-square-plus"></i> Cadastrar</a>
            </span>
        </div>
                        ...
                        foreach ($this->data['packages'] as $package) {
                            ...
                            <tr>
                                ...
                                <td class="d-md-flex flex-row justify-content-center">
                                    ...
                                    <a href='<?php echo "{$_ENV['URL_ADM']}view-package/$id"; ?>' class="btn btn-primary btn-sm me-1 mb-1"><i class="fa-regular fa-eye"></i> Visualizar</a>

                                    <a href='<?php echo "{$_ENV['URL_ADM']}update-package/$id"; ?>' class="btn btn-warning btn-sm me-1 mb-1"><i class="fa-solid fa-pen-to-square"></i> Editar</a>

                                    <form id="formDelete<?php echo $id; ?>" action="<?php echo $_ENV['URL_ADM']; ?>delete-package" method="POST">
