...
class AddAdmsPages extends AbstractSeed
{
    ...
    public function run(): void
    {
        ...
        $pages = [
            ...
            ['name'=> 'Cadastrar Plano de Contas', 'controller' => 'CreateAccountPlan', 'controller_url' => 'create-account-plan', 'directory' => 'accountPlan', 'obs' => 'Página com o formulário cadastrar Plano de Contas.', 'public_page' => 0, 'page_status' => 1, 'adms_packages_page_id' => 1, 'adms_groups_page_id' => 16],
            ['name'=> 'Listar Plano de Contas', 'controller' => 'ListAccountsPlan', 'controller_url' => 'list-accounts-plan', 'directory' => 'accountPlan', 'obs' => 'Página para listar o Plano de Contas.', 'public_page' => 0, 'page_status' => 1, 'adms_packages_page_id' => 1, 'adms_groups_page_id' => 16],
            ['name'=> 'Visualizar Plano de Contas', 'controller' => 'ViewAccountPlan', 'controller_url' => 'view-account-plan', 'directory' => 'accountPlan', 'obs' => 'Página apresentar os detalhes do Plano de Contas.', 'public_page' => 0, 'page_status' => 1, 'adms_packages_page_id' => 1, 'adms_groups_page_id' => 16],
            ['name'=> 'Editar Plano de Contas', 'controller' => 'UpdateAccountPlan', 'controller_url' => 'update-account-plan', 'directory' => 'accountPlan', 'obs' => 'Página com o formulário editar Plano de Contas.', 'public_page' => 0, 'page_status' => 1, 'adms_packages_page_id' => 1, 'adms_groups_page_id' => 16],           
            ['name'=> 'Apagar Plano de Contas', 'controller' => 'DeleteAccountPlan', 'controller_url' => 'delete-account-plan', 'directory' => 'accountPlan', 'obs' => 'Página para apagar o Plano de Contas do banco de dados.', 'public_page' => 0, 'page_status' => 1, 'adms_packages_page_id' => 1, 'adms_groups_page_id' => 16],
