...
class AddAdmsPages extends AbstractSeed
{
    ...
    public function run(): void
    {
        ...
        $pages = [
            ...
            ['name'=> 'AReceber Contas à Receber', 'controller' => 'DeleteReceive', 'controller_url' => 'delete-receive', 'directory' => 'receive', 'obs' => 'Página para apagar o Contas à Receber do banco de dados.', 'public_page' => 0, 'page_status' => 1, 'adms_packages_page_id' => 1, 'adms_groups_page_id' => 14],
